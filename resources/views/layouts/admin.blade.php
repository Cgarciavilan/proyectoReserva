...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('/admin')}}" class="nav-link">Sistema de Reserva de Autos</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('admin')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">CarawasHappy</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link active">
              <i class="nav-icon fas bi bi-truck-front"></i>
              <p>
                Servicios
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/servicios/create')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Creacion de Servicios</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('admin/servicios')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/citas/create')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Agendamiento de Citas</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('admin/citas')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
